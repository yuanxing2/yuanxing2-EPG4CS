...
if __name__ == '__main__':
    ...
    ## Required parameters
    parser.add_argument("--predict_file_path", default='/home/fmy/newproject/yuanxing/PromptCS-main/fewshot/saved_fewshot_result_star1b/test_0.output', type=str)
    parser.add_argument("--ground_truth_file_path", default='/home/fmy/newproject/yuanxing/PromptCS-main/fewshot/saved_fewshot_result_star1b/test_0.gold', type=str)
