...
def prepare_prompt():
    prompt_left = "//Human: You are a helpful code summarizer. Please describe in simple english the purpose of the following Python code snippet: \n"
    prompt_right = "\n//Assistant:"
...
if __name__ == "__main__":
    ...
    with open(os.path.join(args.output_dir, "test_0.output"), 'w', encoding='utf-8') as f, open(
        ...
        for ref, gold, raw in zip(p, examples, all_out):
            ...
            # print(str(gold.idx) + '\t' + gold.target)
            # print(str(gold.idx) + '\t' + raw)
            # break
